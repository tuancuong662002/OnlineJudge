<template>
    <div class="min-h-screen bg-gray-900 text-white">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-gray-300">Problem List</span>
                    </div>
                    <div class="flex items-center space-x-2">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button class="bg-gray-700 text-white px-3 py-1 rounded hover:bg-gray-600">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-blue-400 font-mono">27:02:59</span>
                        <button class="text-gray-400 hover:text-white">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 010 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0v-2.101a7.002 7.002 0 01-11.601-2.566 1 1 0 01.61-1.276z"
                    ...
                    <span class="text-orange-500 font-semibold">Premium</span>
                </div>
            </div>
        </header>
        ...
        <div class="flex h-screen">
            ...
            <div class="w-1/2 bg-gray-900 border-r border-gray-700">
                <!-- Solutions Tab -->
                <div class="bg-gray-800 px-4 py-2 border-b border-gray-700">
                    <div class="flex items-center space-x-2">
                        ...
                        <span class="text-blue-400 font-medium">Solutions</span>
                    </div>
                </div>

                <!-- Tabs -->
                <div class="flex border-b border-gray-700">
                    <button class="px-4 py-3 text-blue-400 border-b-2 border-blue-400 bg-gray-800">
                    ...
                    <button class="px-4 py-3 text-gray-400 hover:text-white flex items-center">
                    ...
                    <button class="px-4 py-3 text-gray-400 hover:text-white">Editorial</button>
                    <button class="px-4 py-3 text-gray-400 hover:text-white">Submissions</button>
                </div>
            ...
            <div class="w-1/2 bg-gray-900 flex flex-col">
                <!-- Code Editor Tabs -->
                <div class="flex border-b border-gray-700">
                    <button class="px-4 py-3 text-gray-400 hover:text-white">Test Result</button>
                    <button class="px-4 py-3 text-gray-400 hover:text-white">Testcase</button>
                    <button class="px-4 py-3 text-green-400 border-b-2 border-green-400 bg-gray-800">
                        <svg class="w-4 h-4 inline mr-2" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                    ...
                    <div class="ml-auto flex items-center space-x-2 px-4">
                        <button class="text-gray-400 hover:text-white">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                                    d="M3 4a1 1 0 011-1h4a1 1 0 010 2H6.414l2.293 2.293a1 1 0 01-1.414 1.414L5 6.414V8a1 1 0 01-2 0V4zm9 1a1 1 0 010-2h4a1 1 0 011 1v4a1 1 0 01-2 0V6.414l-2.293 2.293a1 1 0 11-1.414-1.414L13.586 5H12zm-9 7a1 1 0 012 0v1.586l2.293-2.293a1 1 0 111.414 1.414L6.414 15H8a1 1 0 010 2H4a1 1 0 01-1-1v-4zm13-1a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 010-2h1.586l-2.293-2.293a1 1 0 111.414-1.414L15.586 13V12a1 1 0 011-1z"
                ...
                <!-- Code Editor -->
                <div class="flex-1 bg-gray-900 font-mono text-sm">
                    <div id="editor" style="height: 500px;"></div>
                </div>

                <!-- Bottom Status Bar -->
                <div class="bg-gray-800 px-4 py-2 border-t border-gray-700 flex items-center justify-between text-sm">
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center space-x-2">
                            <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                            <span class="text-gray-300">1157 Online</span>
                        </div>
